...
for name, value in data.items():
    ...
    #     color = (0, 0.4, 0.6)
        ...
        continue
    entropy = [el["train/entropy"] if el["train/entropy"]<0.25 else 0.25 for el in value[:max_len] if "train/entropy" in el]
...
# 保存图像
plt.savefig('logs/entropy.png', dpi=600, bbox_inches='tight')
plt.show()
