...
df = pd.read_csv('utils/visualization/logs/reward.csv')  # 替换为你的文件路径
...
for col_idx in col_idxes:
    ...
    entropy = savgol_filter(entropy, window_length=21, polyorder=3)
...
# 保存图像
plt.savefig('logs/reward_deepscaler.png', dpi=600, bbox_inches='tight')
plt.show()
